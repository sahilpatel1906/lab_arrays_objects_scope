...
deleteCount = 1;
stations.splice(index, deleteCount)
console.log(stations);
 ...
 */
index = stations.indexOf("Newcastle");
const new_array = stations.slice(0, index+1);
const new_array1 = stations.slice(index+1);
stations = [...new_array, "Darlington", ...new_array1];
console.log(stations);
